...
if(
	window.location.hostname.toLowerCase() == "global.yunzhongzhuan.com"
){
	window.location.href = window.location.href.replace(/global.yunzhongzhuan.com/,'www.yunzhongzhuan.com');
}
...
login_content_logo.onclick = function(){
	// window.open('http://yunzhongzhuan.com/welcome/index.html');
}
...
document.domain="heupioneers.com";
...
files_options_item_client_download_button.onclick = function(){
	...
	window.open('//client.yunzhongzhuan.com/');
}
*/
	...
	*/
	...
	for(let i=0;i<files_items.length;i++){
		...
		div.menu_download_element.onclick = function(){
			...
			html_element.innerHTML = "<p style=\"display:none;\"><a href='" + download_web_url + this.parent.url + "' target='_blank'>电信下载（稳定）</a></p><p style=\"display:none;\"><a href='https://ddos-guard-net-download.yunzhongzhuan.com" + this.parent.url + "' target='_blank'>联通下载（稳定）</a></p><p><a style=\"color:#0051c3;border-bottom:2px dashed #0051c3;font-weight:bold;\" href='https://download.pan.heupioneers.com" + this.parent.url + "' target='_blank'>点击下载</a></p>";
			...
			/*if(navigator.language.toLowerCase().indexOf('cn')!=-1&&cdn_cgi_trace_download_hkg==false){
				let p = document.createElement('p');
				let a = document.createElement('a');
				a.href = "https://cdn-upload.yzzpan.com" + this.parent.url;
				a.target = "_blank";
				a.innerText = "本地下载";
				p.append(a);
				html_element.prepend(p);
			...
			if(navigator.language.toLowerCase().indexOf('cn')!=-1&&cdn_cgi_trace_download_hkg==false){
				let p = document.createElement('p');
				let a = document.createElement('a');
				// a.href = "https://cn2-cdn-upload.yunzhongzhuan.com" + this.parent.url;
				a.href = "http://http-redirects-www-http.yzzpan.com/http-redirects.html?url=" + window.btoa("http://cn2-cdn-upload.yunzhongzhuan.com" + this.parent.url);
				a.target = "_blank";
				a.innerText = "点击下载";
				p.append(a);
				html_element.prepend(p);
...
files_main.oncontextmenu=function(e){
	...
	if( folders_items_selected_array.length == 0 && files_items_selected_array.length == 1 ){
		...
		files_download_button.onclick = function(){
			let html_element = document.createElement('div');
			html_element.innerHTML = "<p style=\"display:none;\"><a href='" + download_web_url + files_items_selected_array[0].url + "' target='_blank'>电信下载（稳定）</a></p><p style=\"display:none;\"><a href='https://ddos-guard-net-download.yunzhongzhuan.com" + files_items_selected_array[0].url + "' target='_blank'>联通下载（稳定）</a></p><p><a style=\"color:#0051c3;border-bottom:2px dashed #0051c3;font-weight:bold;\" href='https://download.pan.heupioneers.com" + files_items_selected_array[0].url + "' target='_blank'>点击下载</a></p>";
			...
			if(navigator.language.toLowerCase().indexOf('cn')!=-1&&cdn_cgi_trace_download_hkg==false){
				let p = document.createElement('p');
				let a = document.createElement('a');
				// a.href = "https://cn2-cdn-upload.yunzhongzhuan.com" + files_items_selected_array[0].url;
				a.href = "http://http-redirects-www-http.yzzpan.com/http-redirects.html?url=" + window.btoa("http://cn2-cdn-upload.yunzhongzhuan.com" + files_items_selected_array[0].url);
				a.target = "_blank";
				a.innerText = "点击下载";
				p.append(a);
				html_element.prepend(p);
...
function showpay(){
	...
	content_element.innerHTML = '<img src="//global.yunzhongzhuan.com/img/pay_wx_zfb_qq_2.png" />';
	swal({
...
let cdn_upload_web_url = window.location.protocol + "//cdn-upload.yunzhongzhuan.com";
		...
		if(xmlhttp.readyState==4 && xmlhttp.status==200){
			...
			if(ResultJSON["status"]){
				...
				if(ResultJSON["status_code"]==403){
					let content_element = document.createElement('div');
					content_element.innerHTML = '<img src="//global.yunzhongzhuan.com/img/wechat_bind_1.png" />';
					// 要求绑定微信
					swal({
						title: "微信验证",
						text: ResultJSON["message"],
...
// 接口服务器地址
// let api_server_url = "https://api.yunzhongzhuan.com";
...
let api_server_url = window.location.protocol + "//c34a02aaeb0d6.cname.frontwize.com";
...
if(navigator.language.toLowerCase().indexOf('cn')==-1){
	...
	api_server_url = window.location.protocol + "//api.yunzhongzhuan.com";
	// api_server_url = window.location.protocol + "//mfm.yunzhongzhuan.com";
}
// let api_server_url = "https://ddos-guard-net-api.yunzhongzhuan.com";
...
function show_verify_code(){
	...
	if(navigator.language.toLowerCase().indexOf('cn')==-1){
		...
		new_src = new_src.replace(api_server_url,window.location.protocol+'//api.yunzhongzhuan.com');
...
function get_userinfo(){
	...
	xmlhttp.onreadystatechange=function(){
		/*if(xmlhttp.readyState==4 && (xmlhttp.status==403 || xmlhttp.status==0 ) && api_server_url.indexOf('ddos-guard-net')!=-1 ){
			// window.open('https://ddos-guard-net-api.yunzhongzhuan.com/yunzhongzhuan.com');
			let html_element = document.createElement('div');
...
function show_qqpay(){
	...
	let content_element = document.createElement('div');
	content_element.innerHTML = text + '<img src="//global.yunzhongzhuan.com/img/QQShouKuanMa.png" />';
	...
	xmlhttp.onreadystatechange=function(){
		if(xmlhttp.readyState==4 && xmlhttp.status==200){
			...
			if(ResultJSON["status"]){
				...
				sharefile_content_link_item_download_button_7.href = "https://ddos-guard-net-download.yunzhongzhuan.com" + ResultJSON["url"];
...
let yunzhongzhuan_51la_ip_iframe = document.getElementById('yunzhongzhuan-51la-ip-iframe');
...
window.onload = function(){
	...
	setTimeout(function(){
		// yunzhongzhuan_51la_ip_iframe.src = "/51la_ip";
	},300);
		...
		"data":[
			{
				"name":"v4.0.2",
				"new_open":true,
				"link":"https://yunzhongzhuan.com/welcome/index.html"
			}
		]
	},
	{
	...
	/*
	{
		...
		"data":[
			...
			},
			{
				"name":"关于我们",
				"new_open":true,
				"link":"/welcome/index.html#nav-about-position"
			},
...
login_input_button_wechat_login.onclick = async function(){
	...
	if(swal_element.length>0){
		...
		let content_element = document.createElement('div');
		content_element.innerHTML = '<img src="//global.yunzhongzhuan.com/img/wechat_qrcode_1.png" />';
		...
		if(xmlhttp.readyState==4 && xmlhttp.status==200){
			...
			if(ResultJSON["upload_lock"]){
				...
				upload_lock_functions = function(){
					window.open('https://yunzhongzhuan.com/welcome/index.html#nav-pricing-position');
				}
			}else{
				upload_lock = false;
			}
...
function preview_media(){
	...
	let cache_url = "https://cache.yunzhongzhuan.com/"+cache_id + "/" + files_items_selected_array[0].name;
